            ...
            <div key={index}>
                ...
                <div className="product-list">
                    ...
                    <div className="product-card" key={plantIndex}>
                        ...
                        { addedToCart.hasOwnProperty(plant.name) ? <button className= "product-button btn-disabled" >Added to Cart</button> : addedToCart.hasOwnProperty(plant.name) }<button className= "product-button" onClick={() => handleAddToCart(plant)}>Add to Cart</button>
                    </div>
                    ))}
                </div>
            </div>
